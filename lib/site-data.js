...
function mapDbContentToContent(row) {
  ...
  return {
    ...
    printsHeader: parsePrintContent(row.contact_paragraph_four).printsHeader || "Selected works available as prints.",
    printsBody:
      parsePrintContent(row.contact_paragraph_four).printsBody ||
